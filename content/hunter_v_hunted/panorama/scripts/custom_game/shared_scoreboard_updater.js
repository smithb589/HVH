...
//		$.Msg( "UpdateTeamPanel.Create: ", teamPanelName, " = ", scoreboardConfig.teamXmlName );
	...
	if (teamId == DOTATeam_t.DOTA_TEAM_GOODGUYS)
		netTableVar = "GoodGuyLives";
	else
		netTableVar = "BadGuyLives";

	var teamLives = CustomNetTables.GetTableValue("scores", netTableVar)["value"]

	_ScoreboardUpdater_SetTextSafe( teamPanel, "TeamScore", teamLives )
...
//	$.Msg( "_ScoreboardUpdater_UpdateAllTeamsAndPlayers: ", scoreboardConfig );
	...
	for ( var teamId of Game.GetAllTeamIDs() )
	{
		...
		//$.Msg(Game.GoodGuyLives)
		//$.Msg(Game.GetTeamDetails(teamId));
	}
