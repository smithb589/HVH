...
GG_POWER_STAGE_THRESHOLDS[1] = 16 -- +1 shrapnel (2)
GG_POWER_STAGE_THRESHOLDS[2] = 15 -- meepo nets
GG_POWER_STAGE_THRESHOLDS[3] = 12 -- timberchain
GG_POWER_STAGE_THRESHOLDS[4] = 10 -- +1 shrapnel (3)
GG_POWER_STAGE_THRESHOLDS[5] = 8  -- +2 dogs
GG_POWER_STAGE_THRESHOLDS[6] = 0
...
NEUTRAL_CREEPS_START_TIME	   = 12.0
NEUTRAL_CREEPS_REPEAT_TIME     = 8.0
